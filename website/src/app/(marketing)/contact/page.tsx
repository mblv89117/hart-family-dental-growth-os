...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Contact & Scheduling | Hart Family Dental",
    description: "Request an appointment at Hart Family Dental in Yucca Valley or Desert Hot Springs.",
                ...
                items={[
                  {
                    ...
                    a: "Web requests receive an automated confirmation page. During business hours we aim to follow up as quickly as operations allow. Submitting a form does not confirm an appointment.",
                  },
                  {
                    q: "Can I choose either office?",
                    a: "Yes. Pick the location that fits your schedule and drive time. Hours and emergency availability differ by office.",
                  },
                ]}
              />
            </div>
